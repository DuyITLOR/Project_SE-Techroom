      ...
      <div className='w-full h-auto bg-[linear-gradient(90deg,_#162C4B_100%,_#111827_100%)]  flex items-center justify-center'>
        <div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 justify-between items-center gap-x-30 px-4 pt-2'>
          ...
          <a href="https://maps.app.goo.gl/dLJgCEtYUGq1ZpXb9"
            target='_blank'
            className='font-family text-white text-[15px] leading-[1.5] tracking-[0.9px] text-left sm:text-left mb-4 sm:mb-0'>
          ...
          <div className='tracking-[0.9px] leading-[1.5] text-white font-family text-[14px] gap-x-32'>
            <ul>
              <li>
